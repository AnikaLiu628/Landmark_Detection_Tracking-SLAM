...
class robot:
    ...
    def sense(self):
        ...
        ## All of the landmarks in a world
        ...
        ##    as list.append([index, dx, dy]), this format is important for data creation done.
        index = 0
        for l in self.landmarks:
            dx = (l[0]-self.x) + (self.rand()*self.measurement_noise) #x arix
            dy = (l[1]-self.y) + (self.rand()*self.measurement_noise) #y arix
